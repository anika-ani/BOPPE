      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <button
              className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 px-4 py-2 rounded-lg text-sm font-medium transition-colors"
              disabled
            >
              upgrade
            </button>
      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          <div className="text-center">
            <div className="w-24 h-24 bg-yellow-400 rounded-full mx-auto mb-8 animate-pulse"></div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-96 max-w-md mx-4">
        ...
        <textarea
          ...
          onChange={(e) => setFeedbackText(e.target.value)}
          placeholder="how can we improve Boppe?"
          className="w-full h-32 p-3 border border-gray-200 rounded-lg resize-none outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
        />
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            ...
            <select className="w-full p-2 border border-gray-200 rounded-lg bg-white focus:border-yellow-400 focus:outline-none transition-colors">
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-sm">
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="flex-1 bg-yellow-400 text-black py-3 px-4 rounded-full font-medium hover:bg-yellow-500"
              >
                confirm
              </button>
            </div>
