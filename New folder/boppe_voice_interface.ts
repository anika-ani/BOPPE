...
const VoiceInterface = () => {
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-md">
            <p className="text-gray-700 text-base leading-relaxed">
              okay, so it sounds like you're feeling pretty shook right now.
              <br />
              what's been going in your mind?
            </p>
          </div>
        </div>
  ...
  if (currentState === 'response') {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
        <div className="text-center mb-12">
          <h1 className="text-lg font-medium text-gray-800 mb-8">speaking</h1>
          
          <div className="w-32 h-32 bg-blue-400 rounded-full mx-auto mb-12 animate-pulse"></div>
          
          <div className="max-w-lg">
            <p className="text-gray-700 text-base leading-relaxed">
              I understand it can be overwhelming to carry the weight of the world on your shoulders.
            </p>
          </div>
        </div>
